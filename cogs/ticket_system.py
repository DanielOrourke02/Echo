...
TIMEZONE = config["timezone"] #Timezone use https://en.wikipedia.org/wiki/List_of_tz_database_time_zones#List and use the Category 'Time zone abbreviation'
    ...
    @discord.ui.select(
        ...
        options=[
            discord.SelectOption(
                label="Buying",  #Name of the 1 Select Menu Option
                description="Open for purchasing a service",  #Description of the 1 Select Menu Option
            ...
            discord.SelectOption(
                ...
                description="Apply here or ask questions", #Description of the 2 Select Menu Option
